...
const Footer = () => {
  return (
    <section className="w-10/12 md:w-11/12 lg:w-10/12 mx-auto mt-10 mb-4 flex py-3 gap-6 flex-col md:flex-row justify-between items-center">
          <div>
          <Link href='/'>
          <h4 className="font-semibold text-[20px] text-neutral-200 ">ARISEKOLA</h4>
          </Link>
          </div>
          <div>
          <p className="font-normal text-[14px]  opacity-50 text-neutral-200">Copyright © 2024. All rights reserved.</p>
          </div>
            <div>
